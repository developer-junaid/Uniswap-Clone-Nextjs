...
const style = {
  ...
  buttonAccent: `bg-[#182A42] border border-[#163256] hover:border-[#234169] h-full rounded-2xl flex items-center justify-center text-[#4F90EA]`,
};
  ...
  return (
    <div className={style.wrapper}>
      ...
      <div className={style.buttonsContainer}>
        ...
        {currentAccount ? (
          <div className={`${style.button} ${style.buttonPadding}`}>
            <div className={style.buttonTextContainer}>0x888..5cd</div>
          </div>
        ) : (
          <div
